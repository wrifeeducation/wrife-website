      ...
      <>
        ...
        <div className="min-h-screen bg-[var(--wrife-bg)] py-8">
          <div className="mx-auto max-w-6xl px-4 text-center">
            ...
            <Link href="/staffhub" className="text-[var(--wrife-blue)] hover:underline mt-4 inline-block">
              ← Back to Dashboard
            </Link>
          </div>
        </div>
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[var(--wrife-bg)] py-8">
        <div className="mx-auto max-w-6xl px-4">
          <div className="mb-6">
            <Link href="/staffhub" className="text-[var(--wrife-blue)] hover:underline text-sm">
              ← Back to Dashboard
            </Link>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-soft border border-[var(--wrife-border)] overflow-hidden">
              {teachers.length === 0 ? (
                <div className="p-8 text-center">
                  ...
                  <Link href="/staffhub/users" className="text-[var(--wrife-blue)] hover:underline text-sm mt-2 inline-block">
