    ...
    <>
      ...
      <div className="min-h-screen bg-[var(--wrife-bg)] py-8">
        <div className="mx-auto max-w-4xl px-4">
          <div className="mb-6">
            <Link href="/staffhub" className="text-sm text-[var(--wrife-blue)] hover:underline mb-2 inline-block">
              ← Back to Dashboard
            </Link>
                ...
                <>
                  <div className="flex flex-wrap justify-between items-center mb-4 gap-2">
                    ...
                    <div className="flex gap-2 flex-wrap">
                      ...
                      <Link href={`/staffhub/schools/${schoolId}/invite-teacher`}>
              ...
              {activeTab === 'pupils' && (
                <>
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <Link href={`/staffhub/schools/${schoolId}/add-pupil`}>
                      <button className="rounded-full bg-[var(--wrife-blue)] px-4 py-2 text-sm font-semibold text-white hover:opacity-90 transition">
                        + Add Pupil
                      </button>
                    </Link>
