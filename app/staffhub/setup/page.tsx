    ...
    <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-[400px]">
        ...
        <div className="bg-slate-800 rounded-2xl border border-slate-700 p-6 shadow-2xl shadow-blue-500/10">
          {success ? (
            <div className="text-center">
              ...
              <Link href="/staffhub/login" className="text-sm text-[var(--wrife-blue)] hover:underline">
                Go to login now
              </Link>
            </div>
          ) : (
        ...
        <div className="mt-6 text-center space-y-2">
          ...
          <Link href="/staffhub/login" className="block text-sm text-slate-500 hover:text-white transition">
